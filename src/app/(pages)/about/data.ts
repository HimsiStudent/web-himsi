export const gens = [
  ...
  },
  {
    ...
    year: 2025,
    desc: "Gen XV consists of Samuel Tjen as the President, Yohanes Kenny Putra Sudiono as the Vice President, Muhammad Kynan Khalfani who serves as both Secretary and Treasurer, along with his deputy Farell Eugene. Muhammad Arsyan Rahmani is the Academic Coordinator, alongside Rayhandi Zulmi handling academic affairs. Chandra Galih Endratmo oversees non-academic matters as the Non-Academic Coordinator. Fariza Bunga Azzahra takes charge of Student Relations and Welfare as the Coordinator, while Abimanyu also contributes to student welfare and relations.",
    legacy: "On Progress",
    shortLegacy: "Comming Soon",
  },
];
